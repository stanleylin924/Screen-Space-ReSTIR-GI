...
namespace Falcor
{
    ...
    */
    ...
    public:
        ...
        */
        static SharedPtr create(const Scene::SharedPtr& pScene, const Options& options, int numReSTIRInstances = 1, int ReSTIRInstanceID=0);
    ...
    private:
        ScreenSpaceReSTIR(const Scene::SharedPtr& pScene, const Options& options, int numReSTIRInstances=1, int ReSTIRInstanceID=0);
